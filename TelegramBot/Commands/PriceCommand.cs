...
{
    public class PriceCommand : AbstractCommand, ICommandWithKeyboard, IExplanationString
    {
        ...
        public ExplanationStringsId ExpStringId => ExplanationStringsId.EX_S_PRICE;
